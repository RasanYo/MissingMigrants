...
class QueryGenerator:
    ...
    def generate_queries(self, news_report, languages,q_per_lang):
        ...
        messages=[
            ...
            {"role": "user", "content": f"{prompt}. What are some queries I can use to find similar news articles on Google News? Please return the information in JSON format. Generate a list of {q_per_lang} queries for each of this languages : {languages}. The Json should look like this : {{'english' : {{'1': 'query1_text', '2': 'query2_text'}},...}}" },
        ],
        max_tokens=1000,
